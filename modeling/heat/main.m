...
% Number of tasks
u_num_of_task = 0:0.03:3;
mu_num_of_task_feeble = fuzzifysn(u_num_of_task, 0, num_of_task_type, num_of_task_sf);
mu_num_of_task_few = fuzzifysn(u_num_of_task, 0.75, num_of_task_type, num_of_task_sf);
mu_num_of_task_normal = fuzzifysn(u_num_of_task, 1.5, num_of_task_type, num_of_task_sf);
mu_num_of_task_many = fuzzifysn(u_num_of_task, 2.25, num_of_task_type, num_of_task_sf);
mu_num_of_task_lots = fuzzifysn(u_num_of_task, 3, num_of_task_type, num_of_task_sf);

% Total execution time
u_tot_exe_time = 0:1200000:120000000;
mu_tot_exe_time_verysmall = fuzzifysn(u_tot_exe_time, 0, tot_exe_time_type, tot_exe_time_sf);
mu_tot_exe_time_small = fuzzifysn(u_tot_exe_time, 30000000, tot_exe_time_type, tot_exe_time_sf);
mu_tot_exe_time_mean = fuzzifysn(u_tot_exe_time, 60000000, tot_exe_time_type, tot_exe_time_sf);
mu_tot_exe_time_large = fuzzifysn(u_tot_exe_time, 90000000, tot_exe_time_type, tot_exe_time_sf);
mu_tot_exe_time_verylarge = fuzzifysn(u_tot_exe_time, 120000000, tot_exe_time_type, tot_exe_time_sf);

% Execution time
u_exe_time = 29000000:160000:45000000;
mu_exe_time_extremelyslow = fuzzifysn(u_exe_time, 29000000, exe_time_type, exe_time_sf);
mu_exe_time_slow = fuzzifysn(u_exe_time, 33000000, exe_time_type, exe_time_sf);
mu_exe_time_average = fuzzifysn(u_exe_time, 37000000, exe_time_type, exe_time_sf);
mu_exe_time_fast = fuzzifysn(u_exe_time, 41000000, exe_time_type, exe_time_sf);
mu_exe_time_extremelyfast = fuzzifysn(u_exe_time, 45000000, exe_time_type, exe_time_sf);

% Waiting time
u_wait_time = 15000000:1250000:140000000;
mu_wait_time_veryshort = fuzzifysn(u_wait_time, 15000000, wait_time_type, wait_time_sf);
mu_wait_time_short = fuzzifysn(u_wait_time, 46250000, wait_time_type, wait_time_sf);
mu_wait_time_mediocre = fuzzifysn(u_wait_time, 77500000, wait_time_type, wait_time_sf);
mu_wait_time_long = fuzzifysn(u_wait_time, 108750000, wait_time_type, wait_time_sf);
mu_wait_time_verylong = fuzzifysn(u_wait_time, 140000000, wait_time_type, wait_time_sf);
...
legend('Feeble','Few','Normal','Many','Lots')
...
legend('Very Small','Small','Mean','Large','Very Large')
...
legend('Extremely Slow','Slow','Average','Fast','Extremely Fast')
xlim([29000000 45000000])
...
legend('Very Short','Short','Mediocre','Long','Very Long')
xlim([15000000 140000000])
...
R9 = rulemakem(mu_AB, mu_sel_rate_low);

mu_AB = fuzzyand(mu_num_of_task_few, mu_tot_exe_time_verylarge);
R10 = rulemakem(mu_AB, mu_sel_rate_verylow);
...
R12 = rulemakem(mu_AB, mu_sel_rate_high);
...
R15 = rulemakem(mu_AB, mu_sel_rate_verylow);
...
R17 = rulemakem(mu_AB, mu_sel_rate_high);
...
R24 = rulemakem(mu_AB, mu_sel_rate_low);
...
R17 = rulemakem(mu_AB, mu_sel_rate_verylow);
...
mu_AB = fuzzyand(mu_exe_time_extremelyslow, mu_wait_time_mediocre);
R3 = rulemakem(mu_AB, mu_sel_rate_verylow);
...
mu_AB = fuzzyand(mu_exe_time_fast, mu_wait_time_mediocre);
R18 = rulemakem(mu_AB, mu_sel_rate_high);

mu_AB = fuzzyand(mu_exe_time_fast, mu_wait_time_long);
R19 = rulemakem(mu_AB, mu_sel_rate_veryhigh);
...
mu_AB = fuzzyand(mu_exe_time_extremelyfast, mu_wait_time_short);
R22 = rulemakem(mu_AB, mu_sel_rate_high);

mu_AB = fuzzyand(mu_exe_time_extremelyfast, mu_wait_time_mediocre);
R23 = rulemakem(mu_AB, mu_sel_rate_veryhigh);
