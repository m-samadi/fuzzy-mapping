...
% Number of tasks
u_num_of_task = 4:0.2:24;
mu_num_of_task_feeble = fuzzifysn(u_num_of_task, 4, num_of_task_type, num_of_task_sf);
mu_num_of_task_few = fuzzifysn(u_num_of_task, 9, num_of_task_type, num_of_task_sf);
mu_num_of_task_normal = fuzzifysn(u_num_of_task, 14, num_of_task_type, num_of_task_sf);
mu_num_of_task_many = fuzzifysn(u_num_of_task, 19, num_of_task_type, num_of_task_sf);
mu_num_of_task_lots = fuzzifysn(u_num_of_task, 24, num_of_task_type, num_of_task_sf);

% Total execution time
u_tot_exe_time = 59000000:1970000:256000000;
mu_tot_exe_time_verysmall = fuzzifysn(u_tot_exe_time, 59000000, tot_exe_time_type, tot_exe_time_sf);
mu_tot_exe_time_small = fuzzifysn(u_tot_exe_time, 108250000, tot_exe_time_type, tot_exe_time_sf);
mu_tot_exe_time_mean = fuzzifysn(u_tot_exe_time, 157500000, tot_exe_time_type, tot_exe_time_sf);
mu_tot_exe_time_large = fuzzifysn(u_tot_exe_time, 206750000, tot_exe_time_type, tot_exe_time_sf);
mu_tot_exe_time_verylarge = fuzzifysn(u_tot_exe_time, 256000000, tot_exe_time_type, tot_exe_time_sf);

% Execution time
u_exe_time = 7000000:150000:22000000;
mu_exe_time_extremelyslow = fuzzifysn(u_exe_time, 7000000, exe_time_type, exe_time_sf);
mu_exe_time_slow = fuzzifysn(u_exe_time, 10750000, exe_time_type, exe_time_sf);
mu_exe_time_average = fuzzifysn(u_exe_time, 14500000, exe_time_type, exe_time_sf);
mu_exe_time_fast = fuzzifysn(u_exe_time, 18250000, exe_time_type, exe_time_sf);
mu_exe_time_extremelyfast = fuzzifysn(u_exe_time, 22000000, exe_time_type, exe_time_sf);

% Waiting time
u_wait_time = 59000000:1820000:241000000;
mu_wait_time_veryshort = fuzzifysn(u_wait_time, 59000000, wait_time_type, wait_time_sf);
mu_wait_time_short = fuzzifysn(u_wait_time, 104500000, wait_time_type, wait_time_sf);
mu_wait_time_mediocre = fuzzifysn(u_wait_time, 150000000, wait_time_type, wait_time_sf);
mu_wait_time_long = fuzzifysn(u_wait_time, 195500000, wait_time_type, wait_time_sf);
mu_wait_time_verylong = fuzzifysn(u_wait_time, 241000000, wait_time_type, wait_time_sf);
